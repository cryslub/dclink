...
const api = createMongoDBDataAPI({
    apiKey: 'VHfnN4d7ZgzFTkJxpPCMphHp3YlzVbrykiInk2AzxaHaFSxuq5OKPFfStJqGjBsp',
    urlEndpoint: 'https://us-west-2.aws.data.mongodb-api.com/app/data-xjupy/endpoint/data/v1'
});
